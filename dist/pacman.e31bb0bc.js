...
var Pacman = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Pacman, [{
    ...
    value: function getNextMove(objectExist) {
      var nextMovPos = this.pos + this.dir.movement;

      if (objectExist(nextMovPos, _setup.OBJECT_TYPE.WALL) || objectExist(nextMovPos, _setup.OBJECT_TYPE.GHOSTLAIR)) {
        nextMovPos = this.pos;
      }
...
var POWER_PILL_TIME = 10000; //IN MILLISEC

var GLOBAL_SPEED = 80; //MS

var gameBoard = _GameBoard.default.createGameBoard(gameGrid, _setup.LEVEL); //initail setup
